		...
		return HttpResponseRedirect("/mysite2")
				...
				return render_to_response("index.html",
					  {'user':request.user,
					   ...
					   'TotalCount1' : range(offset-(offset%10)+1,offset-(offset%10)+10),
					   'TotalCount2' : range(offset-(offset%10)+1,offset-(offset%10)+10),
					   'TotalCount3' : range(offset-(offset%10)+1,offset-(offset%10)+10),
					   'Previous1' : Previous1, 
					   'Previous2' : Previous2,
					   'Previous3' : Previous3,
					   'Next1':Next1,
